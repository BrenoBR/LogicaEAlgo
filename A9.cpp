...
double calcularValorConta ()
  {
    return minutos * (tipo + 1);
  }
  
 
 
void setNome (string i)
  {
    nome = i;
  } 
void setTelefone (string i)
  {
    telefone = i;
  } 
int setTipo (int i)
...
cout << "Digite a opcao desejada (1 a 4)\n";
      cin >> i;
...
void
visualizarRelatorio (vector < Cliente > clientes)
{
...
cout << cl.getNome () << ", " << cl.getTelefone () << ", Tipo " << cl.
	getTipo () << ", Minutos: " << cl.
	getMinutos () << ", Conta = R$" << cl.calcularValorConta () << "\n";
...
visualizarReceita (vector < Cliente > clientes)
{
...
listaClientesConsumo (vector < Cliente > clientes)
{
...
if (cl.getMinutos () >= 120)
	cout << cl.getNome () << " utilizou " << cl.
	  getMinutos () << " minutos\n";
...
cout <<
    "Tchau. Esse programa foi desenvolvido por: Breno Henrique Pinto.\n";
