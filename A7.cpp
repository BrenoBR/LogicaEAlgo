...
cout <<
	"O numero nao foi cadastrado, tente novamente. Valores validos: 1 a 10000. "
	<< endl;
...
cout << "O numero da conta C) " << conta.getNumero () << endl;
...
cout <<
	"O limite nao foi cadastrado, tente novamente. Valores validos: 100 a 1000. "
	<< endl;
...
cout << "O limite da conta C) " << conta.getLimite () << endl;
  
cout << "O saldo da conta C) " << conta.getSaldo () << endl;
...
cout << "Nao foi possivel realizar debito." << endl;
